...
This reference covers the instructions to follows when creating or updating a project's context files.
...
### session_history.md
  ...
  6. Update the section named **Last action** in the `session_history.md` file with a description of the last action and the date and time of this last action.
