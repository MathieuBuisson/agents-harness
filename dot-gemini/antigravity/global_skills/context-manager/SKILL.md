...
description:
  ...
  Use this skill to create or update a project plan as a markdown file.
...
This skill explains how to create and maintain project plans to keep track of the status of project phases and tasks.
